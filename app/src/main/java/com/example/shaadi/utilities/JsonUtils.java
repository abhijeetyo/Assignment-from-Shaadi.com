...
public final class JsonUtils {
    ...
    public static ContentValues[] getProfileContentValuesFromJson(Context context, JSONObject profileJson)
        ...
        for (int i = 0; i < jsonProfileArrayList.length(); i++) {
            ...
            profileValues.put(ProfileEntry.COLUMN_PROFILE_GENDER, gender);
            profileValues.put(ProfileEntry.COLUMN_PROFILE_NAME_TITLE,title);
            profileValues.put(ProfileEntry.COLUMN_PROFILE_FIRST_NAME,firstName);
            profileValues.put(ProfileEntry.COLUMN_PROFILE_LAST_NAME, lastName);
            profileValues.put(ProfileEntry.COLUMN_PROFILE_CITY, city);
            profileValues.put(ProfileEntry.COLUMN_PROFILE_STATE, state);
            profileValues.put(ProfileEntry.COLUMN_PROFILE_USERNAME, username);
            profileValues.put(ProfileEntry.COLUMN_PROFILE_AGE, age);
            profileValues.put(ProfileEntry.COLUMN_PROFILE_IMAGE, imageUrl);
            profileValues.put(ProfileEntry.COLUMN_PROFILE_ACCEPTANCE_ID,-1);
